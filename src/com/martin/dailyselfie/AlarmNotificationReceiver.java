...
public class AlarmNotificationReceiver extends BroadcastReceiver {
	...
	private final CharSequence tickerText = "You love yourself so much, why not take a shot now?";
	...
	private final Uri soundURI = Uri
			.parse("android.resource://com.martin.dailyselfie/"
					+ R.raw.alarm_rooster);
	...
	public void onReceive(Context context, Intent intent) {
		...
		mContentIntent = PendingIntent.getActivity(context, 0,
				mNotificationIntent, Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY);
